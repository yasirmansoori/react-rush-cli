...
class Command {
    static async setupProject() {
        ...
        runCommand(`npm create vite@latest ${projectName} -- --template react-ts`, "Failed to create Vite project");
        ...
        if (installTailwind) {
            ...
            runCommand("npm install -D tailwindcss@3 postcss autoprefixer", "Failed to install Tailwind CSS");
...
export default {
  ...
  plugins: [],
            ...
            if (installShadcn) {
                console.log("\n🛠 Setting up ShadCN...\n");
                try {
                    runCommand("npm install -D @types/node", "Failed to install ShadCN dependencies");
